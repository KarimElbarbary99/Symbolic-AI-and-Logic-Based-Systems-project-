"""
    ...
    You can then let your agent compete on the server by calling
        ...
        python3 client_simple.py "C:/Users/kzoubi/Desktop/A1.2 - Play FAUhalma/config7.json"
...
def select_best_move(board, possible_moves, current_player,target_positions):
    move_scores = []
...
def get_monte_carlo_move(board,player_states,target_positions,dif_sum_distance,max_simulation_depth,simulation_number):
    ...
    for simulation in range(simulation_number):
        ...
        while simulated_board.game_over()!=1 and simulation_depth < max_simulation_depth and early_stopping==False:
            ...
            if possible_moves:
                ...
                best_move = select_best_move(simulated_board, possible_moves, current_player,target_positions)
...
def agent_function(request_dict):
    ...
    target_positions = [[(-3, 6),(-3, 5), (-2, 5), (-1, 4), (-2, 4), (-3, 4)],
                        [(3, -6),(3, -5), (2, -5), (1, -4), (2, -4), (3, -4)]]
    best_move1 = get_monte_carlo_move(board,player_states,target_positions,20,70,50)
    if len(best_move1)<1:
        best_move1 = get_monte_carlo_move(board,player_states,target_positions,40,60,500)
